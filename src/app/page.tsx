  ...
  return (
    <div className="min-h-screen bg-[#030307] neural-grid relative overflow-hidden text-text-primary">
      ...
      <nav className="glass-nav sticky top-0 z-50 flex items-center justify-between px-6 md:px-12 py-3.5 border-b border-white/[0.06]">
        ...
        <div className="flex items-center gap-3">
          <a
            href="https://github.com/dkarthikraj/Open-Desk"
            target="_blank"
            rel="noopener noreferrer"
            className="text-xs font-semibold text-text-secondary hover:text-white px-3 py-2 rounded-lg border border-white/10 hover:border-white/20 transition-all flex items-center gap-1.5"
          >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="glass-card-sm text-text-secondary hover:text-white px-7 py-3 rounded-lg font-semibold text-xs hover:border-white/20 transition-all border border-white/10 w-full sm:w-auto flex items-center justify-center gap-2"
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"/></svg>
