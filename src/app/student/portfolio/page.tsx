...
export default function PortfolioPage() {
  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-8 max-w-[1200px]">
      {/* Header Profile */}
      <motion.div variants={item} className="glass-card p-8 relative overflow-hidden border-white/[0.08]">
        <div className="relative flex flex-col md:flex-row items-center gap-6">
          <div className="w-20 h-20 rounded-xl bg-white/10 border border-white/15 flex items-center justify-center text-white font-extrabold text-xl shrink-0">
            KR
          </div>
          <div className="flex-1 text-center md:text-left">
            <div className="flex items-center gap-3 justify-center md:justify-start mb-2">
              <h1 className="text-2xl font-extrabold text-white">D Karthik Raj</h1>
              <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold bg-white/10 text-white border border-white/15">CSE &apos;25</span>
            </div>
            <p className="text-xs text-text-secondary max-w-xl mb-4">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 text-xs font-mono">
              <span className="text-text-muted">VTU Autonomous Institution</span>
              <span className="text-text-muted">• 9.4 CGPA</span>
              <span className="text-emerald-400 font-bold">• Placement Ready</span>
            </div>

          </div>
          <div className="shrink-0 flex gap-3">
            <button className="px-4 py-2.5 rounded-lg bg-white/5 border border-white/10 hover:border-white/20 text-xs font-semibold text-text-secondary hover:text-white transition-colors">
              Export PDF
            </button>
            <button className="px-4 py-2.5 rounded-lg bg-white text-black text-xs font-semibold hover:bg-gray-100 transition-all shadow-sm">
              Share Profile
            </button>
          </div>
        </div>
